...
function TermsBody() {
  return (
    <div className=" flex justify-between">
      <div className=" w-[5.6rem] h-auto  border-2 bg-[#E1FFE4] border-black hidden xl:flex justify-center items-center relative ">
        <h1 className="rotate-[270deg] text-nowrap absolute text-[20px] font-Syncopate font-bold">
          Terms and Conditions
        </h1>
      </div>

      <div className=" w-full  xl:p-20 p-4 bg-[#E1FFE4]  border-2 font-RobotoMono text-center border-black">
        <h1 className=" text-[40px] font-Syncopate uppercase text-center">
          Terms and Conditions
        </h1>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Jamrio Technologies Pvt. Ltd., 12,
              Basavanna Temple Street, Adugodi, Bengaluru.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Kyoto Creative Co, accessible
              from
              <a
                href="kyotocreative.com"
        ...
        <ul>
          <li>
            <p>
              ...
              <a
                ...
                class="__cf_email__"
                data-cfemail="86e4f3f5efe8e3f5f5c6edffe9f2e9e5f4e3e7f2eff0e3a8e5e9eb"
              >
                [email&#160;protected]
              </a>
            </p>
          ...
          <li>
            <p>
              ...
              <a
                href="kyotocreative.com/contact-us"
                rel="external nofollow noopener"
                target="_blank"
              >
                kyotocreative.com/contact-us
              </a>
            </p>
          </li>
        </ul>
      </div>
      <div className=" w-[5.6rem] h-auto  border-2 bg-[#E1FFE4] border-black hidden xl:flex justify-center items-center relative "></div>
    </div>
  );
}
