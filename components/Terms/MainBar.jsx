...
function MainBar() {
  return (
    <div className=" flex justify-between">
      ...
      <div className=" w-full full p-20 bg-[#E1FFE4] relative border-2 border-black">
        <Image
          src={string}
      ...
      <div className=" bg-[#E1FFE4] w-[5.6rem] h-auto border-2 border-black hidden xl:flex justify-center items-center "></div>
    </div>
  );
}
