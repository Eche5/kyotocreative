...
function MainBar() {
  return (
    <div className=" flex justify-between h-auto bg-[#CFE8FF]">
      <div className="  relative w-[5.6rem] h-auto border-2 border-black border-b-0  hidden xl:flex ten:flex  mac:flex justify-center items-center ">
        <h1 className="rotate-[270deg] absolute  text-nowrap text-[20px] font-Syncopate font-bold">
          CONTACT
        </h1>
      </div>
      <div className=" w-full xl:p-20 p-20  relative border-2 border-black flex justify-center items-center">
        <Image
          src={star}
